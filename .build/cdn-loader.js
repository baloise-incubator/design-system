...
exports.defineCustomElements = function(_, opts) {
  return new Promise(function(resolve, reject) {
    if (typeof document !== 'undefined') {
      ...
      mod['data-opts'] = opts;
      mod.src = '__CDN_LOADER_URL__/dist/design-system-components/design-system-components.esm.js';

      var legacy = document.createElement('script');
      legacy.setAttribute('nomodule', '');
      legacy['data-opts'] = opts;
      legacy.src = '__CDN_LOADER_URL__/dist/design-system-components/design-system-components.js';
