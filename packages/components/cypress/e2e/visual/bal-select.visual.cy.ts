describe('bal-select', () => {
  ...
  function visualSelectTest(platform: 'mobile' | 'desktop') {
    describe(platform, () => {
      beforeEach(() => {
        cy.visit('/components/form/bal-select/test/bal-select.visual.html').platform(platform)
      })
  ...
  function visualSelectMultipleTest(platform: 'mobile' | 'desktop') {
    describe(platform, () => {
      beforeEach(() => {
        cy.visit('/components/form/bal-select/test/bal-select-multiple.visual.html').platform(platform)
      })
