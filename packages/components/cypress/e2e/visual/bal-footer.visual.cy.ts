describe('bal-footer', () => {
  ...
  it('basic component', () => {
    cy.platform('fullhd').wait(1000)
    cy.getByTestId('basic').compareSnapshot('basic-footer-fullhd', 0.0)
    cy.getByTestId('all-variations').compareSnapshot('all-variations-footer-fullhd', 0.0)
