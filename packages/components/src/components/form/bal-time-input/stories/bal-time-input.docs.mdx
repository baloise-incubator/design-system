...
<bal-doc-lead>
  <b>Time Input</b> only allows to enter valid times. With decimal property you can set how many decimal places you want
  and time will be formatted accordingly.
</bal-doc-lead>
