...
<bal-doc-banner id="story--components-main-navigation--basic">Main Navigation</bal-doc-banner>
...
<Canvas withSource="open">
  <Story id="components-main-navigation--basic" />
</Canvas>

<bal-doc-app>
  <bal-button-group class="mb-6" position="center">
    <a class="button is-primary" href="?path=/story/components-main-navigation--basic">
...
<bal-doc-github link="/components/bal-main-navigation/stories/bal-main-navigation.docs.mdx"></bal-doc-github>
