...
To provide the icons we need to copy them into your project.
...
After installing our copyfiles dependency we need to define the copy command in our **package.json** file.
Add a new script called **copy:maps** and adjust the second path to your application.

```json
"scripts": {
  "postinstall": "npm run copy:assets",
  "copy:assets": "npm run copy:maps",
  "copy:maps": "copyfiles --flat node_modules/@baloise/design-system-maps/markers/* src/assets/markers"
}
```
